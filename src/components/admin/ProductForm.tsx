          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleInputChange('productCode', e.target.value || undefined)}
                placeholder="Internal product code (admin only)"
                className="touch-manipulation min-h-[44px]"
              />
              <p className="text-xs text-muted-foreground">Internal reference code. Not displayed to customers.</p>
            </div>
          </div>
